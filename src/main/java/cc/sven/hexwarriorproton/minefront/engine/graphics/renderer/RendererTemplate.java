...
abstract class RendererTemplate implements Renderable {
    ...
    public void render(@NonNull final Scanable source, @NonNull final Bufferable target, final int xOffset, final int yOffset) {
        if (executorService == null) {
            renderSinglethreaded(source, target, xOffset, yOffset);
        } else {
            renderMultithreaded(source, target, xOffset, yOffset);
        }
    }
    ...
    private void renderSinglethreaded(@NonNull final Scanable source, @NonNull final Bufferable target, final int xOffset, final int yOffset) {
    ...
    private void renderMultithreaded(@NonNull final Scanable source, @NonNull final Bufferable target, final int xOffset, final int yOffset) {
