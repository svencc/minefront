...
import cc.sven.hexwarriorproton.minefront.game.hex.old.hexgrid.ScreenCoordinate;
...
@Data
public class HexTile implements Scanable {
    ...
    @Builder
    public HexTile(long layoutNumeration, long q, long r, @NonNull HexMap hexMap) {
